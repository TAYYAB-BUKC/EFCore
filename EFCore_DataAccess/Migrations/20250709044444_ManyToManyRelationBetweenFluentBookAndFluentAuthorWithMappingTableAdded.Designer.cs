...
namespace EFCore_DataAccess.Migrations
{
    ...
    [Migration("20250709044444_ManyToManyRelationBetweenFluentBookAndFluentAuthorWithMappingTableAdded")]
    partial class ManyToManyRelationBetweenFluentBookAndFluentAuthorWithMappingTableAdded
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EFCore_Models.Models.Fluent_BookAuthorMapping", b =>
                {
                    b.Property<int>("Author_Id")
                        .HasColumnType("int");
                    ...
                    b.ToTable("Fluent_BookAuthorMapping");
                });
            ...
            modelBuilder.Entity("EFCore_Models.Models.Fluent_Book", b =>
                {
                    b.HasOne("EFCore_Models.Models.Fluent_Publisher", "Publisher")
                        .WithMany("Books")
                        .HasForeignKey("Publisher_Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("EFCore_Models.Models.Fluent_BookAuthorMapping", b =>
                {
                    b.HasOne("EFCore_Models.Models.Fluent_Author", "Author")
                        .WithMany("AuthorBooks")
                        .HasForeignKey("Author_Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
