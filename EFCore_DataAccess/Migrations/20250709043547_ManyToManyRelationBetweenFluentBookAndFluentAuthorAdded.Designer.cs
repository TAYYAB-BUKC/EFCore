...
namespace EFCore_DataAccess.Migrations
{
    ...
    [Migration("20250709043547_ManyToManyRelationBetweenFluentBookAndFluentAuthorAdded")]
    partial class ManyToManyRelationBetweenFluentBookAndFluentAuthorAdded
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Fluent_AuthorFluent_Book", b =>
                {
                    b.HasOne("EFCore_Models.Models.Fluent_Author", null)
                        .WithMany()
                        .HasForeignKey("AuthorsAuthor_Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("EFCore_Models.Models.Fluent_Book", null)
                        .WithMany()
